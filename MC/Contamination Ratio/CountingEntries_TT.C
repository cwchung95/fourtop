void CountingEntries_TT(TString var="ht", float begin = 0, float end=2000, int nbins=20){
	...
	ch.Draw(Form("min(%s,%f-0.000001)>>+Entries", var.Data(), end), "831760/153187316.*evWeight*("+cuts+"&&"+Muons+")","goff");
