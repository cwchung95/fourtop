...
{ 
  ...
  {   
   ...
   // TString deno = "( HLT_IsoMu27 || HLT_IsoMu24 ) && Sum$(Jet_btagDeepB>0.4184 && abs(Jet_eta)<2.4 && Jet_pt>30 && Jet_jetId>1)>=3  && Sum$(Jet_pt>30 && Jet_jetId>1 && abs(Jet_eta)<2.4)>=8";
    ...
    trig = trig1;
    ch.Draw(Form("min(%s,%f-0.00001)>>h1_num", var.Data(), end), "((("+nbcut+"==3&&"+njetscut+"==8"+")/0.95)+"+"(("+nbcut+"==3&&"+njetscut+"==9"+")/0.96)+"+"(("+nbcut+"==3&&"+njetscut+">=10"+")/0.95)+"+"(("+nbcut+">=4&&"+njetscut+"==8"+")/0.96)+"+"(("+nbcut+">=4&&"+njetscut+"==9"+")/0.97)+"+"(("+nbcut+">=4&&"+njetscut+">=10"+"))"+")*"+"("+deno+"&&"+trig+")", "goff");
    trig = "("+trig1+"||"+trig2+")";
    ch1.Draw(Form("min(%s,%f-0.00001)>>+h1_num", var.Data(), end), "((("+nbcut+"==3&&"+njetscut+"==8"+")/0.95)+"+"(("+nbcut+"==3&&"+njetscut+"==9"+")/0.96)+"+"(("+nbcut+"==3&&"+njetscut+">=10"+")/0.95)+"+"(("+nbcut+">=4&&"+njetscut+"==8"+")/0.96)+"+"(("+nbcut+">=4&&"+njetscut+"==9"+")/0.97)+"+"(("+nbcut+">=4&&"+njetscut+">=10"+"))"+")*"+"("+deno+"&&"+trig+")", "goff");
    trig = trig2;
    ch2.Draw(Form("min(%s,%f-0.00001)>>+h1_num", var.Data(), end), "((("+nbcut+"==3&&"+njetscut+"==8"+")/0.95)+"+"(("+nbcut+"==3&&"+njetscut+"==9"+")/0.96)+"+"(("+nbcut+"==3&&"+njetscut+">=10"+")/0.95)+"+"(("+nbcut+">=4&&"+njetscut+"==8"+")/0.96)+"+"(("+nbcut+">=4&&"+njetscut+"==9"+")/0.97)+"+"(("+nbcut+">=4&&"+njetscut+">=10"+"))"+")*"+"("+deno+"&&"+trig+")", "goff");
  }
  //
  //  *********** Drawing Sequence **********  //
