...
void trig_eff_2017v4(TString var="ht", int quad=1, float begin=0, float end=2000, int nbins=20)
{
  ...
  ch1.Draw(Form("min(%s,%f-0.000001)>>h1_num",var.Data(),end), "((("+nbcut+"==3&&"+njetscut+"==8)/0.91)+"+"(("+nbcut+"==3&&"+njetscut+"==9)/0.92)+"+"(("+nbcut+"==3&&"+njetscut+"==10)/0.96)+"+"(("+nbcut+"==3&&"+njetscut+"==11)/0.92)+"+"(("+nbcut+"==3&&"+njetscut+">=12)/0.85)+"+"(("+nbcut+">=4&&"+njetscut+"==8)/0.98)+"+"(("+nbcut+">=4&&"+njetscut+"==9)/0.98)+"+"(("+nbcut+">=4&&"+njetscut+"==10)/0.97)+"+"(("+nbcut+">=4&&"+njetscut+">=11)/1.00)"+")*"+"("+deno+trig1+")", "goff"); 
  ch2.Draw(Form("min(%s,%f-0.000001)>>h1_num",var.Data(),end), "((("+nbcut+"==3&&"+njetscut+"==8)/0.91)+"+"(("+nbcut+"==3&&"+njetscut+"==9)/0.92)+"+"(("+nbcut+"==3&&"+njetscut+"==10)/0.96)+"+"(("+nbcut+"==3&&"+njetscut+"==11)/0.92)+"+"(("+nbcut+"==3&&"+njetscut+">=12)/0.85)+"+"(("+nbcut+">=4&&"+njetscut+"==8)/0.98)+"+"(("+nbcut+">=4&&"+njetscut+"==9)/0.98)+"+"(("+nbcut+">=4&&"+njetscut+"==10)/0.97)+"+"(("+nbcut+">=4&&"+njetscut+">=11)/1.00)"+")*"+"("+deno+trig2+")", "goff"); 
